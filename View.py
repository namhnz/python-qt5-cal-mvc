...
class View(object):
    def setupUi(self, MainWindow):
        ...
        self.displayValueLineEdit = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(24)
        font.setBold(False)
        font.setWeight(50)
        self.displayValueLineEdit.setFont(font)
        self.displayValueLineEdit.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.displayValueLineEdit.setObjectName("displayValueLineEdit")
        self.verticalLayout.addWidget(self.displayValueLineEdit)
